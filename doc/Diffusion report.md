...
| Topic | Doc |
|---|---|
| Simulation environment setup | [doc/仿真环境配置.md](doc/仿真环境配置.md) |
| Robot commander & MoveIt | [doc/robot_commander_README.md](doc/robot_commander_README.md) |
| Keyboard teleoperation | [doc/keyboard_control_README.md](doc/keyboard_control_README.md) |
| Imitation data logging | [doc/imitation_data_recording.md](doc/imitation_data_recording.md) |
| Camera startup for recording | [doc/imitation_data_recording.md](doc/imitation_data_recording.md) |
| Servo control | [doc/伺服控制说明.md](doc/伺服控制说明.md) |
| Hand-eye calibration | [doc/手眼标定说明.md](doc/手眼标定说明.md) |
| RL training overview | [doc/RL_training.md](doc/RL_training.md) |
| Known issues | [doc/Problem.md](doc/Problem.md) |
...
If the RealSense does not start, set `use_head_camera:=false` and continue recording with the wrist camera only. See [doc/imitation_data_recording.md](doc/imitation_data_recording.md) for device listing, troubleshooting, and the full recorder workflow.
