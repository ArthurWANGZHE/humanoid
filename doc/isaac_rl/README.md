...
Launch Isaac entrypoints in this repo directly with `/home/arthur/isaacsim/python.sh`.
...
~/isaacsim/python.sh eval_policy.py \
  --model /home/arthur/humanoid/data/simulation/isaac_rl/logs/ppo_runs/<timestamp>/models/ppo_humanoid_brick_final.zip \
  --headless false \
  --episodes 10 \
  --robot-description-path /home/arthur/humanoid/RL_training/Isaac_RL/assets/robot_description
```
...
```bash
~/isaacsim/python.sh -m tensorboard.main --logdir /home/arthur/humanoid/data/simulation/isaac_rl/logs/ppo_runs
```
...
/home/arthur/isaacsim/python.sh pushcube_isaac_v0/manual_ee_teleop.py     --headless false     --hold-open     --show-ranges     --input-backend terminal --control-mode joint     --joint-step 0.01     --layout-preset right_arm_close


/home/arthur/isaacsim/python.sh pushcube_isaac_v0/manual_ee_teleop.py \
    --headless false \
    --hold-open \
    --show-ranges \
